  ...
  return (
    ...
    >
      <div className="container">
        <SectionTitle
          title="Testimonials"
          paragraph="Partners, educators, and volunteers share how nGreenTech programmes weave measurable action into everyday life."
          center
        />
      ...
      <div className="absolute right-0 top-5 z-[-1]">
        ...
        >
          ...
          <defs>
            ...
            >
              <stop stopColor="#1B9E3F" />
              <stop offset="1" stopColor="#1B9E3F" stopOpacity="0" />
            </linearGradient>
            <linearGradient
              ...
              gradientUnits="userSpaceOnUse"
            >
              <stop stopColor="#1D7CBF" />
              <stop offset="1" stopColor="#1D7CBF" stopOpacity="0" />
            </linearGradient>
          </defs>
        </svg>
      </div>
        ...
        >
          ...
          <defs>
            <linearGradient
              ...
              gradientUnits="userSpaceOnUse"
            >
                <stop stopColor="#1B9E3F" stopOpacity="0" />
                <stop offset="1" stopColor="#1B9E3F" />
            </linearGradient>
            <linearGradient
              ...
              gradientUnits="userSpaceOnUse"
            >
                <stop stopColor="#1D7CBF" stopOpacity="0" />
                <stop offset="1" stopColor="#1D7CBF" />
            </linearGradient>
            <linearGradient
